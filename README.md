# S2.04
Dépot des fichiers utiles au projet
## Modèle relationnel :
Aliment = (id_aliment NUMBER(10), nom_aliment VARCHAR2(40));

Ingredient = (id_ingredient NUMBER(10), nom_ingredient VARCHAR2(15));

Machine = (id_machine NUMBER(10), nom_machine VARCHAR2(25), modele_machine_ VARCHAR2(20));
...
Boisson = (id_boisson NUMBER(10), nom_boisson VARCHAR2(10), type_boisson VARCHAR2(10));
...
Reunion = (id_reunion NUMBER(10), date_reunion TIMESTAMP WITH TIME ZONE, adresse_reunion SDO_GEOMETRY, #id_repas);

Participe_a = (#id_tenrac, #id_reunion);
