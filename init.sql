...
DROP TABLE IF EXISTS Croyances CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS Allergenes CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS UtilisationMachine CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS Boisson CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS NotationPlat CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS Entretien CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS AutresAliments CASCADE CONSTRAINTS PURGE;
...
DROP TABLE IF EXISTS TenracClub CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS TenracOrdre CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS Reunion CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS ParticipeA CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS AccompagneDe CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS PeutHeurter CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS PeutProvoquer CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS UtiliseMachine CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS Utilise CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS EstNote CASCADE CONSTRAINTS PURGE;
DROP TABLE IF EXISTS Attribue CASCADE CONSTRAINTS PURGE;
...
CREATE TABLE Reunion(
   ...
   CONSTRAINT fk_Reunion FOREIGN KEY(id_repas) REFERENCES Repas(id_repas)
);
...
CREATE OR REPLACE TRIGGER gradePass
